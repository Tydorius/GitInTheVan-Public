...
A GitInTheVan Scripts template that uses zero-width unicode characters for invisible state persistence between Script instances. Tracks weather, location, emotional state, inventory, schedule, and character presence without any visible markers in the chat.
...
- Author: [Tydorius on GitInTheVan](https://gitinthevan.com/profiles/0f618e4a-4d83-49da-969b-aba188761259_profile-of-tydorius)
