...
A token-aware lorebook system for GitInTheVan Scripts that builds context sentence-by-sentence based on priority tiers, with configurable message history scope per subject.
...
1. Copy `Progressive_Sentence_Lorebook_Template.js` to your GitInTheVan Scripts
