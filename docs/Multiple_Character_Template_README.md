# Multiple Character Template for GitInTheVan Scripts

This template demonstrates how to implement dynamic character management in GitInTheVan Scripts, allowing characters to drop in and out of scenes based on context mentions.
...
2. Create a new Script in your GitInTheVan character
