...
A token-aware lorebook system for GitInTheVan Scripts that automatically adjusts detail levels based on context relevance and token budgets.
...
1. Copy the template file to your GitInTheVan Scripts
