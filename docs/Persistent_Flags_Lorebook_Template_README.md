...
A GitInTheVan Scripts template that uses hexadecimal flag strings to track persistent state across roleplay sessions. Flags represent discrete states that control which lore context is active.
...
4. Consult GitInTheVan Scripts documentation
...
This template is provided as-is for use with GitInTheVan Scripts. Modify and distribute freely.
