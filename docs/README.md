# GitInTheVan Script Templates

A collection of Script templates for GitInTheVan's enhanced lorebook system. Each template addresses a different use case. Pick the one that fits your scenario, or combine ideas from several.
...
### [TimeDelay Script](TimeDelay_Script_Template.js) | [README](TimeDelay_Script_Template_README.md)| [GitInTheVan Link](https://gitinthevan.com/characters/6387ad41-7000-4734-bc66-e57abdf41b27_character-time-delay-script-template-investigations-delayed-clues-etc)
...
### [Persistent Memory Flags](Persistent_Flags_Lorebook_Template.js) | [README](Persistent_Flags_Lorebook_Template_README.md)| [GitInTheVan Link](https://gitinthevan.com/characters/e10c6c40-e665-44fe-99c8-e0f1e98abefb_character-persistent-memory-script-template)
...
All templates are available on my GitInTheVan profile, ready to copy into your own Scripts.
