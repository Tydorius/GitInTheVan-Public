...
A GitInTheVan Scripts template that prevents LLM omniscience in investigation and mystery scenarios through flag-gated content unlocking, explicit anti-omniscience instructions, and strict information isolation.
...
Created for the GitInTheVan Scripts community. Modify and distribute freely.
