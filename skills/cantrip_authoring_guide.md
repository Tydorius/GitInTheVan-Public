GitInTheVan Script Development

This skill provides guidelines for developing Scripts (enhanced lorebooks) for the GitInTheVan platform.

---

## Platform Overview

GitInTheVan Scripts are JavaScript code embedded in character cards as special lorebook entries. They execute every time the AI generates a response, reading chat state and dynamically modifying character context to create responsive, stateful roleplay scenarios.

Scripts are NOT traditional applications. They are middleware that runs within GitInTheVan's system, reading from the chat context and appending to the character context. Scripts do not persist, and are run fresh with each messaage submission. Scripts can not be guaranteed to execute in a specific order. Scripts do not have a built-in mechanism for transferring data and variables between themselves or for making information persist over time. As such, various mechanisms must be used to ensure data persistence.
...
Scripts run in GitInTheVan's sandboxed JavaScript environment. The environment supports ES6+ natively.
...
The `context` object is the sole interface between the Script and GitInTheVan.
...
GitInTheVan's Test Chat has a "Show Debug Panel" option at the bottom. Use the "Changes" tab to see what the Script injected. `console.log()` output also appears in the debug panel.
...
Official GitInTheVan documentation:
- What are Scripts: https://help.gitinthevan.com/en/article/what-are-scripts-a-beginner-friendly-overview-1s89w2x/
- How to use Scripts: https://help.gitinthevan.com/en/article/how-to-use-scripts-your-beginner-friendly-step-by-step-guide-1bdk5hc/
- Advanced Lorebook by Icehellionx: https://help.gitinthevan.com/en/article/advanced-lorebook-by-icehellionx-peps4q/
- Advanced Lorebook v2 by Icehellionx: https://help.gitinthevan.com/en/article/advanced-lorebook-v2-by-icehellionx-twhuvo/
- Dynamic Lorebook by Icehellionx: https://help.gitinthevan.com/en/article/dynamic-lorebook-by-icehellionx-1ideffa/
- Emotion Engine by Icehellionx: https://help.gitinthevan.com/en/article/emotion-engine-by-icehellionx-1fhy8xp/
- Action & Social Reaction Engine by Icehellionx: https://help.gitinthevan.com/en/article/action-social-reaction-engine-by-icehellionx-lnomag/
- Likes-Dislikes-Fears Engine by Icehellionx: https://help.gitinthevan.com/en/article/likes-dislikes-fears-engine-by-icehellionx-19z33zi/
- Random Encounter by Icehellionx: https://help.gitinthevan.com/en/article/random-encounter-by-icehellionx-arucex/
